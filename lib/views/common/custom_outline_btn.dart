...
class CustomOutlineBtn extends StatelessWidget {
  const CustomOutlineBtn(
      ...
      this.onTap,
      required this.color,
      this.color2, this.titleFontSize});
...
class CustomOutlineBtn extends StatelessWidget {
  const CustomOutlineBtn({
    ...
    required this.color,
    this.color2,
    this.titleFontSize, this.borderRadius, // Added parameter for title font size
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      borderRadius: BorderRadius.circular(borderRadius ?? 0.0), // Add this line to specify rounded corners
