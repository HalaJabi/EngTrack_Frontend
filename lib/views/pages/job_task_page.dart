...
class JobTaskPage extends StatefulWidget {
  const JobTaskPage({required this.job, this.onTap, Key? key})
      : super(key: key);
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                    ...
                    child: FloatingActionButton(
                      onPressed: () {
                        ...
                        Get.to(() => Tasks(jobid: widget.job!.id));
                  ...
                  Positioned(
                    ...
                    child: FloatingActionButton(
                      onPressed: () {
                        Get.to(() => HomeScreen(job: widget.job));
                      },
                      backgroundColor: Colors.white,
                      mini: true,
                  ...
                  Positioned(
                    ...
                    child: FloatingActionButton(
                      onPressed: () {
                        Get.to(() => gannt_chart(jobid: widget.job!.id));
                      },
                      backgroundColor: Colors.white,
                      mini: true,
