...
import 'package:front/models/response/messaging/messaging_res.dart';
...
import 'package:front/views/common/chat_textfiled.dart';
...
class _ChatPageState extends State<ChatPage> {
  ...
  void connect() async {
    ...
    socket =
        IO.io('http://192.168.1.21:8000', <String, dynamic>{
