...
class company_PROFILE_update extends StatefulWidget {
  const company_PROFILE_update({super.key});

  @override
  State<company_PROFILE_update> createState() => _company_PROFILE_updateState();
}

class _company_PROFILE_updateState extends State<company_PROFILE_update> {
...
const HeightSpacer(size: 10),
                  ...
                  CustomTextField(
                    ...
                    hintText: "Founded",
                    keyboardType: TextInputType.text,
                 suffixIcon: const Icon(Icons.calendar_today, color:Color(0xffFE7A36)),
                  ),
                  ...
                  CustomTextField(
                    ...
                    hintText: "Services",
                    keyboardType: TextInputType.text,
                   suffixIcon: const Icon(Icons.business_center, color:Color(0xffFE7A36)),
                  ),
                  ...
                  CustomTextField(
                    ...
                    hintText: "Website",
                    keyboardType: TextInputType.text,
                  suffixIcon: const Icon(Icons.web, color: Color(0xffFE7A36)),
                  ),
